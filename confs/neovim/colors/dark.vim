...
" FloatBorder = { fg = colors.white, },
  ...
  " call Color("Exception", "", "", "") = { fg = colors.purple, },
  " call Color("PreProc", "", "", "") = { fg = colors.yellow, },
  " call Color("Include", "", "", "") = { fg = colors.purple, },
  " call Color("Define", "", "", "") = { fg = colors.purple, },
  " call Color("Title", "", "", "") = { fg = colors.cyan, },
  " call Color("Macro", "", "", "") = { fg = colors.purple, },
  " call Color("PreCondit", "", "", "") = { fg = colors.cyan, },
  " call Color("Type", "", "", "") = { fg = colors.cyan, },
  " call Color("StorageClass", "", "", "") = { fg = colors.pink, },
  " call Color("Structure", "", "", "") = { fg = colors.yellow, },
  " call Color("TypeDef", "", "", "") = { fg = colors.yellow, },
  call Color("Special", s:orange, "", "italic")
  call Color("SpecialComment", s:comment, "", "italic")
  " call Color("Error", "", "", "") = { fg = colors.bright_red, },
  " call Color("Todo", "", "", "") = { fg = colors.purple, bold = true, italic = true, },
  ...
  " call Color("CursorLine", "", "", "") = { bg = colors.selection, },
  " call Color("ColorColumn", "", "", "") = { bg = colors.selection, },
